...
const messages = {
  fr: {
    ...
    'planning.heading': 'Organisez les mêmes tâches en liste, Kanban ou Gantt.',
    ...
    'planning.ganttReadonly': 'Le Gantt est en lecture seule : les créneaux se modifient avec un aperçu validé par Nevolium.',
  ...
  en: {
    ...
    'planning.heading': 'Organise the same tasks as a list, Kanban board or Gantt chart.',
    ...
    'planning.ganttReadonly': 'The Gantt chart is read-only: planning windows are edited through a Nevolium-validated preview.',
