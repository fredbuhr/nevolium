...
## D09 ouvert — correctif d’affichage accepté sur ordinateur, variantes à vérifier
...
| Gate autorisé | Refondation acceptée, [ADR-034](docs/decisions/ADR-034-human-first-refoundation.md) complète ADR-033. DOC-01 et activation D09-REC-01 terminées ; **D09-UX actif**, correctif #99 activé et accepté sur le parcours ordinateur ciblé, D09 non accepté, D10 non commencé |
...
| Prochaine action exécutable | Sur ordinateur, vérifier la liste 2D puis l'ambiance `Calme` : mêmes éléments et ouvertures qu'en 3D, absence de canevas 3D en 2D, préférence 2D persistante après rechargement, réseau bien mis en pause en ambiance calme et reprise correcte en ambiance neurale |
...
| Recette suivante dans la même gate | Après liste 2D et ambiance calme sur ordinateur : téléphone ou tablette, puis second compte pour vérifier que les épingles, dispositions et l'image personnelle du premier compte ne sont pas visibles |
...
Commencer par la liste 2D et l'ambiance calme sur ordinateur ; arrêter au premier défaut important
afin de le qualifier avant d'empiler d'autres observations. Une capture peut être jointe si elle ne montre ni identité, contenu privé, jeton ni
