...
| Champ | État attesté |
|---|---|
| Base main vérifiée | `66f1e6991fb6df09bcb12678b8aadc007934f01a` |
...
| Branche / PR active | Aucune ; la branche D05 fusionnée doit être retirée avant d’ouvrir D06 |
...
| Prochaine action | Retirer uniquement `feat/d05-coherent-cockpit`, puis examiner D06 et ouvrir une seule branche fraîche depuis le `main` live. La revue ergonomique sur appareils physiques reste un suivi produit |
