...
## D09 ouvert — affichage ordinateur accepté, recette tactile à effectuer
...
| Gate autorisé | Refondation acceptée, [ADR-034](docs/decisions/ADR-034-human-first-refoundation.md) complète ADR-033. DOC-01 et activation D09-REC-01 terminées ; **D09-UX actif**, affichage ordinateur accepté, recette tactile et isolation multi-compte restantes, D09 non accepté, D10 non commencé |
...
| Prochaine action exécutable | Sur un téléphone réel, vérifier l'accueil 2D par défaut, l'ouverture tactile d'une fiche, le menu `Affichage`, l'ouverture d'un outil sans superposition et le retour à l'accueil sans débordement horizontal |
...
| Recette suivante dans la même gate | Après la recette téléphone : second compte pour vérifier que les épingles, dispositions et l'image personnelle du premier compte ne sont pas visibles |
...
Commencer par la recette tactile sur un téléphone réel ; arrêter au premier défaut important afin de
