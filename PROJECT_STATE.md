...
| Branche / PR | Une branche active : `fix/d09-kiss-desktop`, fraîche depuis main. [PR #97](https://github.com/fredbuhr/nevolium/pull/97) en brouillon ; code publié `3e0a1186d6afb753b8bc64eed76a78a20e918060`, correctifs de qualification en cours. #96 est fusionnée ; ancienne branche retirée du développement actif |
...
| Validation du gate | Contrat modèle accueil et TypeScript/build locaux réussis. Chromium local ne démarre pas (SIGTRAP environnement) ; CI du code `3e0a118` : 7/8 workflows verts ; UI détecte un débordement de 5 px, un sélecteur de dialogue ambigu et un ancien comptage global des canvas. Corrections ciblées, nouvelle qualification requise ; parcours accueil desktop déjà exécuté jusqu’à la reprise de sauvegarde |
