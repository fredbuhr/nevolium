...
| Validation | `NEVOLIUM-D04-RESEARCH-WEB-COLD-03` reste échouée et conservée avec 2 388 jetons, coût nul, réservation réglée, aucun outil ni artefact. Le correctif `35303f2…` passe **10/10 workflows PR**, dont **5/5 jobs D04** ([run](https://github.com/fredbuhr/nevolium/actions/runs/34758531063)), puis son image et son normaliseur sont vérifiés hors réseau et activés sur la cible. Aucun nouveau workflow, réservation ou Task Research n'apparaît pendant l'activation |
| Prochaine action | Synchroniser le checkpoint documentaire sans rebuild, vérifier de nouveau l'inactivité et les pollers, décharger explicitement `qwen2.5:0.5b`, puis armer une nouvelle mesure froide `NEVOLIUM-D04-RESEARCH-WEB-COLD-04`. Lancer une seule Task authentifiée avec deux appels outils au maximum et l'inspecter avant tout essai chaud ; ne pas rejouer `COLD-03` |
