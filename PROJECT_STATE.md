...
| Branche / PR | Une branche active : `fix/d09-kiss-desktop`, fraîche depuis main. [PR #97](https://github.com/fredbuhr/nevolium/pull/97) en brouillon ; code publié `bf74ba6caabb954e0c29b730ff3190fc027ee46c`, correction finale des commandes mobiles en qualification. #96 est fusionnée ; ancienne branche retirée du développement actif |
...
| Validation du gate | Contrat modèle accueil et TypeScript/build locaux réussis. Chromium local ne démarre pas (SIGTRAP environnement) ; CI `bf74ba6` : 7/8 workflows verts ; D06/D07/D08/spatial passent. Accueil desktop/tablette complet ; téléphone : fiche en flux corrigée, barre 2D/3D à maintenir au-dessus (corrigé). Le test D05 referme désormais le réglage ouvert avant de cliquer Accueil. Nouvelle tête à qualifier |
