...
| Validation du correctif | Tête `2911d5d…`, UI run `35099526070` : D05/D06/D08/3D verts ; cas sans relations 3 appartenances, 489 pixels animés, 0 en pause ; 7 autres workflows verts. D07 passe création/contenu/sauvegarde/brouillon/citations/restauration/inter-projets mais échoue sur le repérage exact du sélecteur de contexte EN. Libellé accessible explicite ajouté ; requalification complète de la nouvelle tête requise. Captures FR de saisie et graphe peu relié inspectées |
