...
| Branche / PR | Une branche active : `fix/d09-kiss-desktop`, fraîche depuis main. [PR #97](https://github.com/fredbuhr/nevolium/pull/97) en brouillon ; code publié `12fdc81a3ec2620d924113e3326b07f42887d830`, cadrage portrait et synchronisation du test WebGL en qualification. #96 est fusionnée ; ancienne branche retirée du développement actif |
...
| Validation du gate | Contrat modèle accueil et TypeScript/build locaux réussis. Chromium local ne démarre pas (SIGTRAP environnement) ; CI `12fdc81` : accueil complet sur 3 formats et D05/D06/D07 verts ; 9 captures revues. Deux points résiduels corrigés : cadrage portrait initial et injection de perte WebGL qui précédait parfois l’initialisation asynchrone du renderer dans le test. Nouvelle tête à qualifier ; aucun déploiement |
