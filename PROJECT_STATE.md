...
| Référence qualifiée D09 | `25997d2e78d9696d4ab8bda2ebe60fc18822996f` : **8/8 workflows PR verts**, dont parcours D05–D09, kit hors ligne et contrats PostgreSQL ; UI run `35032575243`. Bandes au zoom corrigées ; jonctions lumineuses à atténuer |
| Présent descendant | Reprise organique demandée après essais utilisateur : membranes D05, faisceaux ramifiés, voiles diffus, épaisseur bornée au zoom et opacité des jonctions corrigée ; vérifier les checks du head live #93, sans transférer automatiquement les résultats du parent |
