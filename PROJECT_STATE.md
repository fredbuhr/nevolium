...
## D09 ouvert — correctif d’affichage actif, acceptation navigateur à effectuer
...
| Gate autorisé | Refondation acceptée, [ADR-034](docs/decisions/ADR-034-human-first-refoundation.md) complète ADR-033. DOC-01 et activation D09-REC-01 terminées ; **D09-UX actif**, correctif #99 activé techniquement, D09 non accepté, D10 non commencé |
...
| Prochaine action exécutable | Recette navigateur sur ordinateur des trois corrections : démarrage 3D attendu avec préférence desktop neuve, menu unique `Affichage · 3D`, disparition complète de ce menu pendant l'ouverture d'un outil. Arrêter au premier défaut important et fournir une capture expurgée si utile |
...
Commencer par la recette navigateur sur ordinateur et arrêter au premier défaut important afin de
le qualifier avant d'empiler d'autres observations. Une capture peut être jointe si elle ne montre ni identité, contenu privé, jeton ni
