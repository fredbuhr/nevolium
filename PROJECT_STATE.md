...
| Prochaine action | Terminer la qualification de l’extension Accueil et corpus dans la branche PR #96 : publier le travail local si autorisé, exécuter PostgreSQL et Chromium puis inspecter les captures. Aucun go ni déploiement anticipé ; le prochain déploiement devra inclure Core et Web. D10 reste fermé |
...
| Publication autorisée | L’utilisateur autorise explicitement le 16 septembre l’envoi dans `fredbuhr/nevolium`, PR #96, et la poursuite de la qualification. Le refus auto-review antérieur est levé. Git CLI sans identifiants ; transfert par la connexion GitHub authentifiée, avec contrôle de l’arbre. PostgreSQL et Chromium en CI restent à qualifier |
