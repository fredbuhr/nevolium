...
| Prochaine action | Après stabilisation, vérifier les identités/restarts et les santés en lecture seule, puis qualifier dans le navigateur : authentification, FR/EN, Planning, Knowledge, Mindmap 2D, Mycelium 3D, sélection 2D↔3D, persistance et tactile |
