...
| Référence qualifiée D09 | `3cf5c9fa3a7cad39e5bb541d4faf35842c7b4aa8` : **8/8 workflows PR verts**, UI run `35045011382` ; 13 scénarios spatiaux, 16 contrôles kit ; animation 3 007 pixels, calme 0 ; translucence et progression lumineuse examinées |
| Présent descendant | Affinage du tissu qualifié : noyaux moins facettés, lumière interne plus douce, anticrénelage latéral des fils, courbes 18/40/52 segments (budget éco restauré), fibres incidentes visibles, têtes ambrées locales. Le parent 2402b25 a deux timeouts de capture stress en logiciel ; diagnostics ajoutés, critères conservés. Vérifier CI/captures/film du head live #93 ; acceptation utilisateur encore ouverte |
...
| Preuves | Archive matière translucide du 16 septembre : rapport/hash et référence ; candidat 3cf5c9f kit `10426068713`, navigateur `10427185081`, spatial `10426737424`. SHA exact et artefacts de l’affinage dans #93 après validation |
