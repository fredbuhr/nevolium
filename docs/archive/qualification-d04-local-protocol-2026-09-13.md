# Protocole D04 local remplacé le 13 septembre 2026

Document historique, jamais une instruction de reprise. Conservé depuis le commit
`25566363c66bcc41980077214c3f379e2880f3a4`. La décision utilisateur abandonne le LLM local pour le pilote.
Le [protocole actif](../qualification-d04.md) et l'[ADR-031](../decisions/ADR-031-api-first-pilot.md)
supplantent les étapes de présélection Ollama, de réglage CPU et de qualification froid/chaud ci-dessous.
